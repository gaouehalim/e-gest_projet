...
<head>
    ...
    <span class="mx-2 text-gray-500 dark:text-gray-300 rtl:-scale-x-100"><?php echo $nomSite;?></span>
</div>
    <div class="w-full max-w-sm m-auto pt-5 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    <img class="object-cover object-center w-full h-56" src="<?php echo ($cover ? $cover : '../assets/images/defaultpp.png'); ?>" alt="avatar">
    ...
    <path d="M4.462 19.462c.42-.419.753-.89 1-1.395.453.214.902.435 1.347.662a6.742 6.742 0 0 1-1.286 1.794.75.75 0 0 1-1.06-1.06Z" />
        ...
        <h1 class="mx-3 text-lg font-semibold text-green-400"><?php echo $nomSite;?></h1>
    </div>
    ...
    <div class="px-6 py-4">
        ...
        <path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" />
            ...
            <h1 class="px-2 text-sm"><?php echo $contactSite;?></h1>
        </div>
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm"><?php echo $emailSite;?></h1>
        </div>  
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm"><?php echo $adresseSite;?></h1>
        </div>
        ...
        <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 0 0 0-1.5h-3.75V6Z" clip-rule="evenodd" />
            ...
            <h1 class="px-2 text-sm"><?php echo $dateCreat;?></h1>
        </div>
        <h1 class="mt-3 text-xl font-semibold text-gray-800 dark:text-white"><span class="text-green-400 font-bold">Gestionnaire :</span> <?php echo $prenom.' '. $nom;?> </h1>

        <p class="py-2 text-gray-700 dark:text-gray-400"></p>
        <button class="items-center px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-600 rounded-lg hover:bg-gray-500 ">
            <a href="modsite.php">   
