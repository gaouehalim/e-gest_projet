...
include 'setting.php';
    ...
    if (isset($_POST['modSite'])) {
        ...
        if (!empty($nom) && !empty($email) && !empty($tel) && !empty($adresse)) {
            ...
            $stmt1->execute([$nom, $email, $tel, $adresse, $ps, $idSite]);
        ...
        <!-- Sidebar -->
            ...
            <div class="px-8 py-8">
                <form class="w-full max-w-md" method="POST" action="" enctype="multipart/form-data">               
                    <h1 class="mt-1 text-center text-gray-500 dark:text-gray-400 pb-5">Les informations du site <span class="text-green-400 font-bold" ></h1>
               ...
               <?php endif; ?>
                    ...
                    <div class="relative flex items-center mt-4">
                        ...
                        <input type="text" name="telSite" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-green-400 dark:focus:border-green-300 focus:ring-green-300 focus:outline-none focus:ring focus:ring-opacity-40" value="<?php echo $contactSite; ?>">
                    </div>
                    ...
                    <div class="relative flex items-center mt-4">
                        ...
                        <input type="email" name="emailSite" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-green-400 dark:focus:border-green-300 focus:ring-green-300 focus:outline-none focus:ring focus:ring-opacity-40" value="<?php echo $emailSite; ?>">
                    </div>
                    <div class="relative flex items-center mt-4">
                    <span class="absolute">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                        ...
                        <input type="text" name="adresseSite" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-green-400 dark:focus:border-green-300 focus:ring-green-300 focus:outline-none focus:ring focus:ring-opacity-40" value="<?php echo $adresseSite; ?>">
                    </div>
        
                  
        
                    <div class="flex items-center justify-between mt-4">        
                        <input type="submit" name="modSite" class="px-6 py-2 m-auto text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-500 rounded-lg hover:bg-green-400 focus:outline-none focus:ring focus:ring-green-300 focus:ring-opacity-50" value="Modifier">
                    </div>
                </form>
            </div>
